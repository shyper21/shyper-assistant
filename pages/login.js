  ...
  return (
    <>
      ...
      <style jsx>{`
        ...
        .card { position:relative; z-index:1; background:rgba(20,10,40,0.9); border:1px solid rgba(157,78,221,0.3); border-radius:20px; padding:40px 32px; width:100%; max-width:380px; display:flex; flex-direction:column; align-items:center; gap:14px; }
        ...
        .input { width:100%; background:rgba(10,5,25,0.8); border:1px solid rgba(106,90,205,0.4); border-radius:12px; padding:12px 16px; color:#d0c4f4; font-size:1rem; font-family:'Rajdhani',sans-serif; outline:none; }
        .input:focus { border-color:rgba(157,78,221,0.7); }
        .btn { width:100%; padding:12px; background:linear-gradient(135deg,#7c3aed,#9d4edd); border:none; border-radius:12px; color:#fff; font-family:'Rajdhani',sans-serif; font-size:1rem; font-weight:600; letter-spacing:0.1em; cursor:pointer; margin-top:4px; }
        .btn:disabled { opacity:0.5; cursor:not-allowed; }
        .error { color:#ff6b6b; font-size:0.82rem; text-align:center; }
      `}</style>
    </>
  )
}
